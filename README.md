...
Once this project is in a decent state, I'll setup Windows / Mac / Linux builds and releases.

# Contribution

For now, I'd like to keep the repository closed to contribution for the sake of my own learning. In the future (probably once I've implemented what I want to implement), I will consider allowing pull requests.
